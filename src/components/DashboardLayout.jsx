            ...
            >
                ...
                <nav className="flex-1 overflow-y-auto px-2 pb-4 space-y-1 mt-2">
                    ...
                    <div className="pt-4">
                        ...
                        <SidebarItem
                            to="/done/pr-validation"
                            icon={<Activity />}
                            label="PR Validation"
                            isActive={location.pathname.includes('pr-validation') || isProcessDetailPage}
                        />
                    </div>
                    ...
                    <div className={`flex items-center gap-3 transition-opacity duration-150 ${!isSidebarOpen ? 'pl-8' : ''}`}>
                        <div className="flex items-center gap-2 text-[13px]">
                            {location.pathname.includes('/knowledge-base') ? (
                                <>
                                    <button onClick={() => navigate('/done/pr-validation')} className="hover:bg-white rounded p-1 transition-colors">
